 ...
 *    access;
 *
 * 5. This function establishes a mapping between the user-space virtual
 *    memory area described by vma and the physical memory range specified by
 *    vma->vm_pgoff and size;
 *
 * Context: process context.
 *
 * Return:
